...
def build_fpn_mask_graph(rois, feature_maps, image_meta,
    ...
    # Conv layers
    # Shape: [batch, num_rois, MASK_POOL_SIZE, MASK_POOL_SIZE, 256]
    ...
    # Shape: [batch, num_rois, 2*MASK_POOL_SIZE, 2*MASK_POOL_SIZE, 256]
    x = KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2, activation="relu"),
                           name="mrcnn_mask_deconv")(x)
    # Shape: [batch, num_rois, 2*MASK_POOL_SIZE, 2*MASK_POOL_SIZE, num_classes]
